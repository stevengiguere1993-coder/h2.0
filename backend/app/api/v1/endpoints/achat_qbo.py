"""Push an Achat to QuickBooks Online as a Bill or Purchase.
...
Note : l'envoi du PO par courriel a été déplacé vers
/api/v1/purchase-orders/{id}/send-po depuis la refonte PO/Achat.
"""
