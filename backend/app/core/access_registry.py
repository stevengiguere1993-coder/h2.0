...
PAGES: list[PageEntry] = [
    ...
    _p("prospection.leads", "Suivi de leads", "prospection", "employee",
       "/prospection/leads"),
    # Repérage terrain = employé ; données FINANCIÈRES (analyses d'achat,
    # deals, stats) = gestionnaire (logique métier 2026-07-24).
    _p("prospection.analyses", "Analyses des leads", "prospection",
       "manager", "/prospection/analyses-leads"),
    _p("prospection.pipeline", "Pipeline", "prospection", "manager",
    ...
    _p("prospection.kanban", "Kanban Prospection", "prospection", "employee",
       "/prospection/kanban"),
    # ── Gestion immobilière ──
    # Défauts « gestionnaire » (logique métier 2026-07-24) : la gestion
    # locative — immeubles, baux, finances, locataires — est le travail
    # des GESTIONNAIRES. Les employés terrain passent par l'app mobile
    # construction (/m) ; un employé qui a besoin d'une page précise la
    # reçoit par exception individuelle ou en baissant son seuil ici.
    _p("immobilier.vue_ensemble", "Vue d'ensemble locative", "immobilier",
       "manager", "/immobilier"),
    _p("immobilier.immeubles", "Immeubles", "immobilier", "manager",
       "/immobilier/immeubles"),
    _p("immobilier.logements", "Logements", "immobilier", "manager",
       "/immobilier/logements"),
    _p("immobilier.locataires", "Locataires", "immobilier", "manager",
       "/immobilier/locataires"),
    _p("immobilier.baux", "Baux & paiements", "immobilier", "manager",
       "/immobilier/baux"),
    ...
    _p("immobilier.communications", "Communications", "immobilier",
       "manager", "/immobilier/communications"),
    _p("immobilier.modeles_documents", "Modèles de documents", "immobilier",
       "manager", "/immobilier/modeles-documents"),
    _p("immobilier.finances", "Finances locatives", "immobilier", "manager",
       "/immobilier/finances"),
    _p("immobilier.renouvellements", "Suivis annuels",
       "immobilier", "manager", "/immobilier/renouvellements"),
    _p("immobilier.depots", "Dépôts de garantie", "immobilier", "manager",
       "/immobilier/depots"),
    _p("immobilier.bons_travail", "Bons de travail (locatif)", "immobilier",
       "manager", "/immobilier/bons-travail"),
