...
_AFTER_HOURS_RULES = (
    ...
    "LOCATAIRE — fais le TRI entre une vraie urgence et une demande qui "
    "peut attendre :\n"
    "  • VRAIE URGENCE (danger pour les personnes ou dommage qui ne peut "
    "pas attendre) : feu, fumée, fuite de gaz, dégât d'eau / inondation, "
    "refoulement d'égout, absence totale de chauffage en hiver, panne "
    "électrique complète, porte ou serrure brisée (sécurité), arbre "
    "tombé, personne blessée ou décès. → next_action = transfer_emergency "
    "(transfert IMMÉDIAT aux gestionnaires, 24 h sur 24). Dis : « Je vous "
    "mets en relation avec le gestionnaire de garde. »\n"
    "  • DEMANDE QUI PEUT ATTENDRE (réparation mineure, robinet qui "
    "goutte, question de bail ou de paiement, bruit, demande "
    "administrative) : NE transfère PAS. Explique poliment que ce n'est "
    "pas une urgence et que les bureaux sont fermés, et invite le "
    "locataire à RAPPELER pendant les heures d'ouverture. Propose de "
    "prendre un message (next_action = callback avec nom + numéro + "
    "motif) si la personne le souhaite ; sinon conclus poliment.\n"
    "  • En cas de DOUTE sur la gravité, pose UNE question pour clarifier "
    "(next_action = continue) avant de décider.\n"
    "CLIENT CONSTRUCTION / RÉNOVATION ou tout autre appel : NE transfère "
    "pas et ne propose pas de rendez-vous. Prends un message "
    "(next_action = callback), on rappelle à la réouverture."
)
