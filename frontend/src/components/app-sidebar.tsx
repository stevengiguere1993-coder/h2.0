...
const CONSTRUCTION_NAV: NavItem[] = [
  ...
  { href: "/app/ordres-travail", label: "Ordres de travail", icon: ClipboardCheck, minRole: "employee" },
  { href: "/app/agenda", label: "Agenda", icon: Calendar, minRole: "employee" },
  { href: "/app/bons", label: "Bons de travail (devis signés)", icon: ClipboardCheck, minRole: "manager" },
