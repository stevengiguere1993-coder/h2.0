    ...
    <div className="p-4 lg:p-6">
      <header className="flex flex-wrap items-start justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="inline-flex items-center gap-1.5 rounded-lg border border-white/15 bg-brand-950 px-3 py-1.5 text-xs font-semibold text-white/80 hover:border-violet-300 hover:text-violet-200 disabled:opacity-50"
          >
            {syncingAll ? (
      ...
      <section className="mt-6">
        {feeds === null ? (
          ...
          <div className="rounded-2xl border border-dashed border-brand-800 bg-brand-900/40 p-6 text-center">
