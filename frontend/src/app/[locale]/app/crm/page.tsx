...
const DEFAULT_COLUMNS: Column[] = [
  ...
  // Rempli automatiquement quand un appel sortant vers le prospect
  // reste sans réponse (SMS + courriel partent en même temps).
  { id: "a_rappeler", label: "À rappeler", dot: "bg-orange-400" },
