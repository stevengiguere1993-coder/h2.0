...
const NAV: NavItem[] = [
  ...
  { href: "/immobilier/baux", label: "Paiements", icon: ClipboardList },
  { href: "/immobilier/suivi-baux", label: "Baux", icon: ClipboardList },
  { href: "/immobilier/locations", label: "Locations", icon: KeyRound },
  { href: "/immobilier/communications", label: "Communications", icon: Mail },
