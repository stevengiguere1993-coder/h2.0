        ...
        <header className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 max-w-2xl text-sm text-white/60">
              Ordres de travail par immeuble : urgences, planifié, terminé.
              Crée-les depuis la fiche d&apos;un immeuble.
            </p>
          </div>
        </header>
                ...
                <li key={imm.id}>
                  ...
                  >
                    ...
                    <p className="mt-1 text-[11px] text-white/50">
                      {imm.nb_logements_actifs} logement
                      {imm.nb_logements_actifs > 1 ? "s" : ""}
                    </p>
                  </Link>
                </li>
              ))}
